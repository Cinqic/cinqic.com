(function () {
  ...
  if (menu && nav) {
    ...
    nav.addEventListener("click", function (event) {
      if (event.target.matches("a")) closeMenu(false);
    });
  ...
  document.querySelectorAll("[data-company-copy]").forEach(function (element) {
    element.textContent = window.CINQIC.companyCopy();
  });
