...
PAGES=[ROOT/"index.html",ROOT/"juniper-math-1/index.html",ROOT/"privacy/index.html",ROOT/"calculator/index.html",ROOT/"404.html"]
REQUIRED=[ROOT/"CNAME",ROOT/"robots.txt",ROOT/"sitemap.xml",ROOT/"site.webmanifest",ROOT/"assets/css/site.css",ROOT/"assets/js/company.js",ROOT/"assets/js/site.js",ROOT/"assets/img/juniper-social.png",ROOT/"assets/img/juniper-math-social.svg"]
...
def main():
 ...
 forbidden=["http:"+"//cinqic.com","Coming"+" soon","lorem"+" ipsum","Anthro"+"pic","Constitu"+"tional"+" AI","Juniper"+" Baby","Juniper 1 "+"20"+"M","20"+" million","19"+",863,936"]
 for term in forbidden:
  if term.lower() in public.lower():return fail("obsolete or insecure public text: "+term)
 if "Juniper Math 1" not in public:return fail("missing Juniper Math 1 migration")
 if "5,004,032" not in public:return fail("missing verified parameter target")
 if "August 27, 2026" not in public:return fail("missing preserved launch date")
 if "https://github.com/Cinqic/juniper-math-1" not in public:return fail("missing canonical Juniper Math 1 repository")
 for page in PAGES:
